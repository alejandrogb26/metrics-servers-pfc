 ...
 * operaciones de persistencia, como consultas SQL, inserciones,
 * actualizaciones o eliminaciones en la base de datos.
 * </p>
 *
 * <p>
 * Su propósito principal es desacoplar las excepciones técnicas
 * generadas por la infraestructura (por ejemplo {@link java.sql.SQLException})
 * de las capas superiores de la aplicación. De esta forma, el resto del
 * sistema no depende directamente de detalles específicos del motor
 * de base de datos o de la API JDBC.
 * </p>
 *
 * <p>
 * Normalmente esta excepción es capturada por un {@code ExceptionMapper}
 * global que la transforma en una respuesta de error adecuada para la API.
 * </p>
 *
 * <p>
